-- PostgreSQL Script - Database: banking

-- 1. Eliminación de tablas en orden inverso por llaves foráneas
...
-- 2. Tabla: customers
-- Usamos GENERATED BY DEFAULT para permitir insertar los IDs manuales (2000-2005)
-- y que el siguiente automático sea 2006.
CREATE TABLE customers (
  customer_id INT GENERATED BY DEFAULT AS IDENTITY (START WITH 2006) PRIMARY KEY,
...
CREATE TABLE accounts (
  account_id INT GENERATED BY DEFAULT AS IDENTITY (START WITH 95474) PRIMARY KEY,
