...
import (
	...
	domain "github.com/singhparbjyot/banking/domain"
...
func (m *MockCustomerService) GetAllCustomers(status string) ([]domain.Customer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCustomers", status)
...
func (mr *MockCustomerServiceMockRecorder) GetAllCustomers(status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCustomers", reflect.TypeOf((*MockCustomerService)(nil).GetAllCustomers), status)
}

// GetCustomer mocks base method.
func (m *MockCustomerService) GetCustomer(arg0 string) (*dto.CustomerResponse, *errors.AppError) {
	m.ctrl.T.Helper()
